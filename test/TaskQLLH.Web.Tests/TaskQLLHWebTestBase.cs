...
{
    public abstract class TaskQLLHWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TaskQLLHWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TaskQLLHWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TaskQLLHDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TaskQLLHDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TaskQLLHDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TaskQLLHDbContext, Task<T>> func)
        {
            T result;
